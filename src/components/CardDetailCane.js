...
function CardDetailCane({ icon,nameCard, outPutCard, unitCard, backgroundColor,iconColor,titleColor,unitColor }) {
  return (
    <div className="card mb-0 ml-1 mr-1 p-4 shadow border-0 col-md-9 col-lg-2 col-xs-4 col-sm-4" style={{ maxWidth: "156", backgroundColor:backgroundColor , minHeight: "160px",borderRadius:"0px"}}>
